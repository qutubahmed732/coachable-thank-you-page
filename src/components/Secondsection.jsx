...
function Secondsection() {
  return (
    ...
    <section className="flex flex-col items-center justify-center h-auto p-8 md:p-12 bg-[url('../../Desktop_Version/JPEG_Backgrounds/hook.jpg')] bg-no-repeat bg-cover bg-center text-center">
